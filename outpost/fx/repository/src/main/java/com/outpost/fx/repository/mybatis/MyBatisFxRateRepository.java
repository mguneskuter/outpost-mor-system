...
public final class MyBatisFxRateRepository implements FxRateRepository {
   ...
   */
  @Override
  public Optional<com.outpost.fx.FxRate> findFxRateByPairAndRateDate(
  ...
  private static com.outpost.fx.FxRate toFxRate(FxRate row) {
    return new com.outpost.fx.FxRate(
        row.fxRateId(),
