package com.outpost.ledger.accounting.queue;
...
class AccountingQueueIntakeIntegrationTest {
  ...
  @Autowired private AccountingQueueService accountingRequestService;
  ...
  private boolean accept(CyclicBarrier bothReady, AccountingQueueRequest request) throws Exception {
    ...
    try {
      ...
      return true;
    } catch (AccountingQueueRefusedException locked) {
      return false;
    }
  }
