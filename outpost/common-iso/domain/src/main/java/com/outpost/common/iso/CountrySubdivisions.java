...
public enum CountrySubdivisions {
  ...
  CountrySubdivisions(long countrySubdivisionId, String code, String name) {
    value =
        new CountrySubdivision(
            countrySubdivisionId, Countries.UNITED_STATES.getValue(), code, name);
  }

  /** Returns the {@link CountrySubdivision} owned by this constant. */
  public CountrySubdivision getValue() {
    return value;
  }
  ...
  public static Optional<CountrySubdivision> fromCode(String code) {
    ...
    return Optional.ofNullable(BY_CODE.get(code)).map(CountrySubdivisions::getValue);
  }
  ...
  public static Optional<CountrySubdivision> fromCode(Countries.Country country, String code) {
    ...
    Objects.requireNonNull(code, "code");
    return fromCode(code).filter(subdivision -> subdivision.getCountry().equals(country));
  }
  ...
  public static final class CountrySubdivision {
    ...
    private CountrySubdivision(
      ...
      if (code == null
          ...
          || !code.startsWith(country.getIsoCode())) {
        throw new IllegalArgumentException(
